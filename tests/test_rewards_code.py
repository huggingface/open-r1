import unittest
from open_r1.rewards_internal.code.htgen import totality_check_reward, mk_dataset_totality_check, fix_triple_reward, mk_dataset_fix_triple
...
class TestRewardsCode(unittest.TestCase):
    ...
    def test_fix_triple_reward(self):
        triple = {
            "pre": "v3 > 0 && v4 > 2",
            "program": "v5 = 2\nv3 = v5\nv4 = ((5 + (3 + v3)) + (v4 + v5))\nv4 = 9\nv4 = (v3 - 7)",
            "post": "v5 > 6"
