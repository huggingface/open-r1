...
_deps = [
    ...
    "liger_kernel==0.5.3",
    "lighteval @ git+https://github.com/huggingface/lighteval.git@f3639c6769c6d4cb80173321e3266871421485e4",  # Proper pass@1 for math: https://github.com/huggingface/lighteval/pull/661
