...
To run the code in this project, first, create a Python virtual environment using e.g. Conda, uv. To install `uv`, follow the [UV Installation Guide](https://docs.astral.sh/uv/getting-started/installation/)
