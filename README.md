...
It is possible to be rate limited when too many scripts are executed on E2B Sandboxes, we provide an E2B router script that can be launched on CPU node on your cluster:
...
Then add this line in your config: (for example)
```
